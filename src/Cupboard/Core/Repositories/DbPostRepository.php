<?php namespace Cupboard\Core\Repositories;

use Config, Cache, DateTime, Validator;
use Cupboard\Core\Models\Post;
use Cupboard\Core\Models\Tag;
...
class DbPostRepository implements PostRepositoryInterface {
	...
	/**
	 * Search from the cupboard facet
	 *
	 * @param  array   $params
	 * @return array
	 */
