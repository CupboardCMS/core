...
use Cupboard\Core\Repositories\DbUserRepository as UserRepositoryInterface;
...
class UserCommand extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'cupboard:user:create';
	 ...
	 * @var string
	 */
	protected $description = 'Creates a user for CupboardCMS.';
