...
class DropzoneController extends BaseController {
	...
	public function postImage()
	{
		...
		$imageDir = Config::get('core::cupboard.image_dir');
		$destinationPath = public_path(). "/{$imageDir}/";
		$filename = $file->getClientOriginalName();
		$resizeEnabled = Config::get('core::cupboard.image_resize.enabled');
		
		if ($resizeEnabled)
		{
			$resizeWidth = Config::get('core::cupboard.image_resize.width');
			$resizeHeight = Config::get('core::cupboard.image_resize.height');
