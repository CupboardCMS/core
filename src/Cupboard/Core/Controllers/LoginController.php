...
use View, Input, Redirect, Auth, Password, Cupboard;
...
class LoginController extends BaseController {
	 ...
	 *
	 * @param  \Cupboard\UserRepositoryInterface
	 */
	protected $users;
	...
	public function store()
	{
		...
		{
			return Redirect::route('cupboard.admin.index');
		}
	...
	{
		$this->auth->logout();
		return Redirect::route('cupboard.admin.login');
	}
